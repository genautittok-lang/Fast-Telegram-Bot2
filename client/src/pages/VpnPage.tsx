...
const labels: Record<Lang, Record<string, string>> = {
  en: {
    ...
    proRequiredDesc: "PRO: 3 devices · ENTERPRISE: 10 · GROUPS: 25. All 6 regions, no logs, no speed limits.",
  ...
  uk: {
    ...
    proRequiredDesc: "PRO: 3 пристрої · ENTERPRISE: 10 · GROUPS: 25. Усі 6 регіонів, без логів, без обмежень швидкості.",
  ...
  ru: {
    ...
    proRequiredDesc: "PRO: 3 устройства · ENTERPRISE: 10 · GROUPS: 25. Все 6 регионов, без логов, без ограничений скорости.",
  ...
  es: {
    ...
    proRequiredDesc: "PRO: 3 dispositivos · ENTERPRISE: 10 · GROUPS: 25. Las 6 regiones, sin logs, sin límites de velocidad.",
  ...
  de: {
    ...
    proRequiredDesc: "PRO: 3 Geräte · ENTERPRISE: 10 · GROUPS: 25. Alle 6 Regionen, keine Logs, keine Geschwindigkeitsbegrenzung.",
