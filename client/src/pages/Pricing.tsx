...
function PricingContent() {
  ...
  const [selectedMethod, setSelectedMethod] = useState<"crypto" | "googlepay" | "applepay" | null>(null);
              ...
              >
                      ...
                      <div className="space-y-2">
                        ...
                        >
                          <div className="w-10 h-10 rounded-lg bg-zinc-800 flex items-center justify-center shrink-0">
                            <svg width="18" height="22" viewBox="0 0 170 200" fill="white">
                ...
                {paymentStep === "details" && showPaymentModal && (
                  <div className="space-y-4" data-testid="payment-step-details">
                    ...
                    {(selectedMethod === "googlepay" || selectedMethod === "applepay") && (
                      <div className="space-y-4">
                        <div className="p-4 rounded-xl bg-gradient-to-br from-violet-500/10 to-transparent border border-violet-500/30 text-center">
                          ...
                          <p className="text-sm font-medium mb-1">{selectedMethod === "googlepay" ? "Google Pay" : "Apple Pay"}</p>
                          ...
                          <Button
                            className={`w-full ${selectedMethod === "googlepay" ? "bg-blue-600" : "bg-zinc-800"}`}
                            onClick={async () => {
                              try {
                                ...
                                if (response.ok && data.pageUrl) {
                                  ...
                                  toast({
                                    title: selectedMethod === "googlepay" ? "Google Pay" : "Apple Pay",
                            ...
                            disabled={timerExpired}
                            data-testid={`button-${selectedMethod}-checkout`}
                          >
                            {selectedMethod === "googlepay" ? (
                              ...
                              <svg width="14" height="16" viewBox="0 0 170 200" fill="white" className="mr-2">
                                <path d="M150.4 172.3c-7.8 18.2-16.3 27-30.5 27-8.1 0-13.6-4.7-22.4-4.7-9.1 0-15.2 4.8-22.8 4.8-14.4 0-28.1-18.1-38.7-42.7C26.1 132.4 20 109.3 20 87.3c0-35.2 23-53.8 45.5-53.8 9.8 0 17.9 5.4 24 5.4 5.8 0 14.8-5.7 25.9-5.7 7.3 0 23.6 2.8 33.2 17.7-1.2.8-23.6 14.3-23.6 38.7 0 28.2 24.6 38.1 25.4 38.4zM114.5 0c-17.1 1.3-33.3 18.9-31.5 36.8 15.6 0 33.2-17.2 31.5-36.8z"/>
                              </svg>
                            )}
                            {selectedMethod === "googlepay"
                              ? (t('pricing.payWithGooglePay') || "Pay with Google Pay")
                              : (t('pricing.payWithApplePay') || "Pay with Apple Pay")}
                          </Button>
                        </div>
                      </div>
                    )}
