...
const SECTIONS = [
  ...
  },
  {
    ...
    content: "Кожен тарифний план має чітко визначений ліміт запитів (FREE: 5/день, PRO: 50/день, ENTERPRISE/GROUPS: 500/день). Спроби обійти ліміти через множинні акаунти, проксі-ротацію чи скриптування караються негайним блокуванням всіх пов'язаних акаунтів. API-ключі ENTERPRISE забороняється передавати/перепродавати."
  },
  {
