...
export default function Guide() {
  ...
  const faqItems = [
    { q: L("Скільки перевірок я можу робити безкоштовно?", "Сколько проверок я могу делать бесплатно?", "How many free checks can I do?"), a: L("FREE тариф дає 5 перевірок на день. Додаткові перевірки можна отримати через реферальну програму (+5 за кожного друга) або разовий аудит за $3.", "FREE тариф даёт 5 проверок в день. Дополнительные проверки можно получить через реферальную программу (+5 за каждого друга) или разовый аудит за $3.", "FREE plan gives 5 checks per day. Earn more via the referral program (+5 per friend) or a one-time $3 audit pack.") },
