...
export default function Guide() {
  ...
  const faqItems = [
    { q: L("Скільки перевірок я можу робити безкоштовно?", "Сколько проверок я могу делать бесплатно?", "How many free checks can I do?"), a: L("FREE тариф дає 5 перевірок-бонусів при реєстрації + 1 безкоштовну перевірку щодня. Додаткові перевірки можна отримати через реферальну програму (+5 за кожного друга) або разовий аудит за $3.", "FREE тариф даёт 5 бонусных проверок при регистрации + 1 бесплатную проверку в день. Дополнительные проверки можно получить через реферальную программу (+5 за каждого друга) или разовый аудит за $3.", "FREE plan gives 5 signup-bonus checks + 1 free check per day. Earn more via the referral program (+5 per friend) or a one-time $3 audit pack.") },
    ...
    { q: L("Як оплатити підписку?", "Как оплатить подписку?", "How to pay for subscription?"), a: L("Підписку можна оплатити через: криптовалюту (TON, USDT, ETH, BTC), Telegram Stars, або промокод. Оплата доступна як через бота, так і через сайт на сторінці Pricing.", "Подписку можно оплатить через: криптовалюту (TON, USDT, ETH, BTC), Telegram Stars, или промокод. Оплата доступна как через бота, так и через сайт.", "You can pay via: cryptocurrency (TON, USDT, ETH, BTC), Telegram Stars, or promo code. Payment available both via bot and website Pricing page.") },
        ...
        <Section title={L("Тарифні плани", "Тарифные планы", "Subscription Plans")} icon={<CreditCard className="w-4 h-4 text-primary" />} delay={0.2}>
          ...
          <div className="p-3 rounded-lg bg-primary/5 border border-primary/10">
            <p className="text-xs text-muted-foreground">
              {L(
                "Оплата: Криптовалюта (TON -5%, USDT, ETH, BTC), Telegram Stars, промокоди. Підписка оновлюється вручну.",
                "Оплата: Криптовалюта (TON -5%, USDT, ETH, BTC), Telegram Stars, промокоды. Подписка обновляется вручную.",
                "Payment: Crypto (TON -5%, USDT, ETH, BTC), Telegram Stars, promo codes. Subscription renews manually."
              )}
            </p>
          </div>
          <Link href="/pricing">
