...
export const translations: Record<Language, TranslationSchema> = {
  en: {
    ...
    pricing: {
      ...
      paymentUSDT: "Payment USDT TRC-20 (TRON)",
      ...
      paymentNote: "Payment via USDT (TRC-20) cryptocurrency. The application will be sent to the administrator for confirmation.",
      ...
      planLabel: "Plan",
      checksPerDay15: "15 checks per day",
    ...
    referral: {
      ...
      activeBonus: "+15 requests + 5% discount",
  ...
  uk: {
    ...
    pricing: {
      ...
      paymentUSDT: "Оплата USDT TRC-20 (TRON)",
      ...
      paymentNote: "Оплата криптовалютою USDT (TRC-20). Заявка буде відправлена адміністратору для підтвердження.",
      tronNetwork: "TRON Network",
    ...
    referral: {
      ...
      activeBonus: "+15 запитів + 5% знижка",
  ...
  ru: {
    ...
    pricing: {
      ...
      paymentNote: "Оплата криптовалютой USDT (TRC-20). Заявка будет отправлена администратору для подтверждения.",
      tronNetwork: "TRON Network",
    ...
    referral: {
      ...
      activeBonus: "+15 запросов + 5% скидка",
  ...
  es: {
    ...
    pricing: {
      ...
      paymentUSDT: "Pago USDT TRC-20 (TRON)",
      ...
      paymentNote: "Pago con criptomoneda USDT (TRC-20). La solicitud será enviada al administrador para confirmación.",
      tronNetwork: "TRON Network",
      ...
      planLabel: "Plan",
      checksPerDay15: "15 verificaciones por día",
      ...
      checksPerDay100: "100 verificaciones por día",
    ...
    referral: {
      ...
      activeBonus: "+15 solicitudes + 5% descuento",
  ...
  de: {
    ...
    pricing: {
      ...
      paymentUSDT: "Zahlung USDT TRC-20 (TRON)",
      ...
      paymentNote: "Zahlung mit USDT (TRC-20) Kryptowährung. Der Antrag wird zur Bestätigung an den Administrator gesendet.",
      tronNetwork: "TRON Network",
    ...
    referral: {
      ...
      activeBonus: "+15 Anfragen + 5% Rabatt",
