...
export const translations: Record<Language, TranslationSchema> = {
  en: {
    ...
    pricing: {
      ...
      planLabel: "Plan",
      checksPerDay15: "1 check per day + 5 signup bonus",
  ...
  uk: {
    ...
    pricing: {
      ...
      planLabel: "План",
      checksPerDay15: "1 перевірка на день + 5 бонусних при реєстрації",
  ...
  ru: {
    ...
    pricing: {
      ...
      planLabel: "План",
      checksPerDay15: "1 проверка в день + 5 бонусных при регистрации",
    ...
    dashboard: {
      ...
      services: {
        ...
        wallet: {
          ...
          mixerDetection: "Обнаружение миксеров",
          mixerDetectionDesc: "Обнаружение Tornado Cash и др.",
          multiChain: "Multi-Chain",
          multiChainDesc: "ETH, BTC, TRX, SOL, LTC, XRP, DOGE",
          exchangeUid: "UID биржи",
        ...
        hash: {
          ...
          signatureMatch: "Совпадение сигнатур",
  ...
  es: {
    ...
    pricing: {
      ...
      planLabel: "Plan",
      checksPerDay15: "1 verificación por día + 5 de bono al registrarse",
  ...
  de: {
    ...
    pricing: {
      ...
      planLabel: "Plan",
      checksPerDay15: "1 Prüfung pro Tag + 5 Bonus bei Anmeldung",
