...
export const OSINT_SOURCES: OsintSource[] = [
  ...
  { name: "Snusbase", url: "https://snusbase.com", category: "leaks" },
  { name: "BreachDirectory", url: "https://breachdirectory.org", category: "leaks" },
  { name: "IntelligenceX", url: "https://intelx.io", category: "leaks" },
  { name: "Scylla", url: "https://scylla.sh", category: "leaks" },
  { name: "WeLeakInfo", url: "https://weleakinfo.to", category: "leaks" },
  { name: "Hudson Rock", url: "https://hudsonrock.com", category: "leaks" },
  { name: "LeakBase", url: "https://leakbase.io", category: "leaks" },
  { name: "Nuclear Leaks", url: "https://nuclearleaks.com", category: "leaks" },
